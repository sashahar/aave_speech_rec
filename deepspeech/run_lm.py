...
parser.add_argument(
    "--lm-alpha", default=0.5, type=float, help="Language model weight end tuning"
)
parser.add_argument(
    "--lm-beta", default=0.5, type=float, help="Language model word bonus (all words)"
)
parser.add_argument(
...
if __name__ == "__main__":
    ...
    decoder = BeamCTCDecoder(
        ...
        blank_index=characters.index("_"),
        alpha=args.lm_alpha,
        beta=args.lm_beta,
    )
